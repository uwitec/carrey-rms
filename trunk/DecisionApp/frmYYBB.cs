...
{
	public class frmYYBB : System.Windows.Forms.Form
	{
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmYYBB));
			this.GroupBox1 = new System.Windows.Forms.GroupBox();
			base.Closed += new System.EventHandler(frmYYBB_Closed);
			...
			this.CrystalReportViewer1.Size = new System.Drawing.Size(664, 424);
		...
		private void ExeDbProc(string begintime, string endtime)
		{
			...
			try
			{
				...
				MysqlProc.CommandText = "proc_Dept_sum";
		...
		private void frmYYBB_Closed(object sender, System.EventArgs e)
		{
			rms_var.frm_Yybb = null;
		}
		
		//直接控件 datagrid 打印
		//Private Sub MakeDocPrint(ByVal doc As C1PrintDocument, ByVal e As GenerateEventArgs)
		//doc.DefaultUnit = C1.C1PrintDocument.UnitTypeEnum.Mm
		//doc.StartDoc()
		//Dim pdg As New ControlPrinters.DataGridPrintInfo
		
		//pdg.PageBreak = ControlPrinters.DataGridPrintInfo.PageBreaksEnum.ClipInArea
		//pdg.VarRowHeight = ControlPrinters.DataGridPrintInfo.RowHeightEnum.LikeGrid
		
		//pdg.RepeatColumnHeaders = True
		//doc.RenderBlockText(Me.Text + " " + Chr(13) + "打印时间：" + Now.ToString, 150, 10, Nothing)
		//doc.RenderBlockC1Printable(DataGrid1, doc.BodyAreaSize.Width, Nothing, pdg, Nothing)
		//doc.RenderBlockText("", 200, 10, Nothing)
		//doc.RenderBlockText("餐厅管家管理系统 2.0 ", 200, 10, Nothing)
		//doc.EndDoc()
		//End Sub
		
		private void Button3_Click(System.Object sender, System.EventArgs e)
		{
			if (MessageBox.Show("确定要打印当前预览视图中的报表内容吗？", "提示", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) == DialogResult.Yes)
			{
		...
		private void Button1_Click(System.Object sender, System.EventArgs e)
		{
			...
			string sqlstr;
			sqlstr = "SELECT * from view_dept_sum order by deptname";
			
			ParameterFieldDefinitions crParameterFieldDefinitions;
			ParameterFieldDefinition crParameterFieldDefinition;
			ParameterValues crParameterValues;
			ParameterDiscreteValue crParameterDiscreteValue;
			ReportDocument cr_yybb_tmp = new ReportDocument();
			
			//检测报表文件是否存在
			if (File.Exists(rms_var.GetReportPath() + report_var.Yybb_rpt_filename))
			{
				cr_yybb_tmp = report_var.LoadReport(rms_var.GetReportPath() + report_var.Yybb_rpt_filename, sqlstr, "view_dept_sum");
			}
			else
			{
			...
			crParameterFieldDefinitions = cr_yybb_tmp.DataDefinition.ParameterFields;
			...
			CrystalReportViewer1.ReportSource = cr_yybb_tmp;
