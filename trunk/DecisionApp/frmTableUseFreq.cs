...
{
	public class frmTableUseFreq : System.Windows.Forms.Form
	{
		
		#region  Windows 窗体设计器生成的代码
		
		public frmTableUseFreq()
		{
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmTableUseFreq));
			this.CrystalReportViewer1 = new CrystalDecisions.Windows.Forms.CrystalReportViewer();
			base.Closed += new System.EventHandler(frmTableUseFreq_Closed);
			...
			this.CrystalReportViewer1.Size = new System.Drawing.Size(624, 400);
		...
		private void ExeDbProc(string begintime, string endtime)
		{
			...
			try
			{
				...
				MysqlProc.CommandText = "proc_TableUseFreq_sum";
		...
		private void frmTableUseFreq_Closed(object sender, System.EventArgs e)
		{
			rms_var.frmTblUseFreq = null;
		}
		...
		private void Button1_Click(System.Object sender, System.EventArgs e)
		{
			...
			string sqlstr;
			sqlstr = "select * from tableusefreq order by tabletypename,tableno,freq";
			
			ParameterFieldDefinitions crParameterFieldDefinitions;
			ParameterFieldDefinition crParameterFieldDefinition;
			ParameterValues crParameterValues;
			ParameterDiscreteValue crParameterDiscreteValue;
			ReportDocument cr_tableusefreq_tmp = new ReportDocument();
			
			//检测报表文件是否存在
			if (File.Exists(rms_var.GetReportPath() + report_var.tableusefreq_rpt_filename))
			{
				cr_tableusefreq_tmp = report_var.LoadReport(rms_var.GetReportPath() + report_var.tableusefreq_rpt_filename, sqlstr, "tableusefreq");
			}
			else
			{
			...
			crParameterFieldDefinitions = cr_tableusefreq_tmp.DataDefinition.ParameterFields;
			...
			CrystalReportViewer1.ReportSource = cr_tableusefreq_tmp;
