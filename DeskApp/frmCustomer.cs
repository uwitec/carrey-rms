		...
		private void ToolBar1_ButtonClick(System.Object sender, System.Windows.Forms.ToolBarButtonClickEventArgs e)
		{
			switch (ToolBar1.Buttons.IndexOf(e.Button))
			{
				...
				case 2: //删除当前数据
					if (! (dgCust.CurrentRowIndex < 0))
					{
						if (MessageBox.Show("确定要删除当前选中的编号为 " + dgCust[dgCust.CurrentRowIndex, 0].ToString() + " 的客户信息吗？", "提示", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) == DialogResult.Yes)
						{
							//删除操作
