...
namespace DeskApp
{
	public class frmBalanceTypeQry : System.Windows.Forms.Form
	{
		
		#region  Windows 窗体设计器生成的代码
		
		public frmBalanceTypeQry()
		{
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmBalanceTypeQry));
			this.Panel1 = new System.Windows.Forms.Panel();
			base.Load += new System.EventHandler(frmBalanceTypeQry_Load);
			base.Closed += new System.EventHandler(frmBalanceTypeQry_Closed);
			...
			this.CrystalReportViewer1.Size = new System.Drawing.Size(544, 376);
		...
		private void frmBalanceTypeQry_Load(System.Object sender, System.EventArgs e)
		{
		...
		private void frmBalanceTypeQry_Closed(object sender, System.EventArgs e)
		{
			rms_var.frmblnctypqry = null;
		}
		...
		private void Button1_Click(System.Object sender, System.EventArgs e)
		{
			...
			string sqlstr;
			sqlstr = "SELECT * from view_Balancetype where paytime>='" + DateTimePicker1.Text + " " + DateTimePicker2.Text + "' and " + "paytime<='" + DateTimePicker3.Text + " " + DateTimePicker4.Text + "' ";
			...
			ReportDocument cr_BalanceType_tmp = new ReportDocument();
			
			//检测报表文件是否存在
			if (File.Exists(rms_var.GetReportPath() + report_var.BalanceTypQry_rpt_filename))
			{
				cr_BalanceType_tmp = report_var.LoadReport(rms_var.GetReportPath() + report_var.BalanceTypQry_rpt_filename, sqlstr, "view_balancetype");
			}
			else
			{
			...
			crParameterFieldDefinitions = cr_BalanceType_tmp.DataDefinition.ParameterFields;
			...
			CrystalReportViewer1.ReportSource = cr_BalanceType_tmp;
