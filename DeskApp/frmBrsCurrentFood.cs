...
namespace DeskApp
{
	public class frmBrsCurrentFood : System.Windows.Forms.Form
	{
		
		#region  Windows 窗体设计器生成的代码
		
		public frmBrsCurrentFood()
		{
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmBrsCurrentFood));
			this.Button1 = new System.Windows.Forms.Button();
			base.Load += new System.EventHandler(frmBrsCurrentFood_Load);
			base.Closed += new System.EventHandler(frmBrsCurrentFood_Closed);
			...
			this.DataGridTableStyle1.MappingName = "Currentfoodlist";
			//
			...
			this.DataGridTextBoxColumn7.HeaderText = "时价";
		...
		//返回特价菜菜品列表
		private void GetCurrentFoodList()
		{
			...
			try
			{
				...
				selectCMD.CommandText = "select * from view_foodlist where currentfood='1'";
				selectCMD.CommandTimeout = 30;
				SqlDataAdapter dbDA = new SqlDataAdapter();
				dbDA.SelectCommand = selectCMD;
				conn.Open();
				DataSet dbDS = new DataSet();
				dbDA.Fill(dbDS, "CurrentFoodList");
				dgFoodList.DataSource = null;
				dgFoodList.DataSource = dbDS;
				dgFoodList.DataMember = "CurrentFoodList";
			}
			catch (Exception ex)
			{
		...
		private void frmBrsCurrentFood_Load(System.Object sender, System.EventArgs e)
		{
			GetCurrentFoodList();
		}
		
		private void frmBrsCurrentFood_Closed(object sender, System.EventArgs e)
		{
			rms_var.frmbrscfod = null;
		}
