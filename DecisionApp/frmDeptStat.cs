...
{
	public class frmDeptStat : System.Windows.Forms.Form
	{
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmDeptStat));
			this.CrystalReportViewer1 = new CrystalDecisions.Windows.Forms.CrystalReportViewer();
			base.Closed += new System.EventHandler(frmDeptStat_Closed);
		...
		private void ExeDbProc(string begintime, string endtime)
		{
			...
			try
			{
				...
				MysqlProc.CommandText = "proc_dept_stat_sum";
		...
		private void Button1_Click(System.Object sender, System.EventArgs e)
		{
			...
			string sqlstr;
			sqlstr = "select * from dept_stat";
			
			ParameterFieldDefinitions crParameterFieldDefinitions;
			ParameterFieldDefinition crParameterFieldDefinition;
			ParameterValues crParameterValues;
			ParameterDiscreteValue crParameterDiscreteValue;
			ReportDocument cr_dept_stat_tmp = new ReportDocument();
			
			//检测报表文件是否存在
			if (File.Exists(rms_var.GetReportPath() + report_var.dept_stat_rpt_filename))
			{
				cr_dept_stat_tmp = report_var.LoadReport(rms_var.GetReportPath() + report_var.dept_stat_rpt_filename, sqlstr, "Dept_stat");
			}
			else
			{
			...
			crParameterFieldDefinitions = cr_dept_stat_tmp.DataDefinition.ParameterFields;
			...
			CrystalReportViewer1.ReportSource = cr_dept_stat_tmp;
			
			Cursor = Cursors.Default;
		}
		
		private void frmDeptStat_Closed(object sender, System.EventArgs e)
		{
			rms_var.frmDeptSt = null;
		}
	}
