...
{
	public class frmDeptCost : System.Windows.Forms.Form
	{
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmDeptCost));
			this.CrystalReportViewer1 = new CrystalDecisions.Windows.Forms.CrystalReportViewer();
			base.Closed += new System.EventHandler(frmDeptCost_Closed);
			...
			this.CrystalReportViewer1.Size = new System.Drawing.Size(568, 352);
			...
			this.GroupBox1.Size = new System.Drawing.Size(552, 83);
		...
		private void ExeDbProc(string begintime, string endtime)
		{
			...
			try
			{
				...
				MysqlProc.CommandText = "proc_dept_cost_sum";
		...
		private void Button1_Click(System.Object sender, System.EventArgs e)
		{
			...
			string sqlstr;
			sqlstr = "select yearmonth,deptname,storagetypename,sum(cost) as cost from dept_cost_sum group by yearmonth,deptname,storagetypename";
			
			ParameterFieldDefinitions crParameterFieldDefinitions;
			ParameterFieldDefinition crParameterFieldDefinition;
			ParameterValues crParameterValues;
			ParameterDiscreteValue crParameterDiscreteValue;
			ReportDocument cr_dept_cost_tmp = new ReportDocument();
			
			//检测报表文件是否存在
			if (File.Exists(rms_var.GetReportPath() + report_var.dept_cost_rpt_filename))
			{
				cr_dept_cost_tmp = report_var.LoadReport(rms_var.GetReportPath() + report_var.dept_cost_rpt_filename, sqlstr, "dept_cost_sum");
			}
			else
			{
			...
			crParameterFieldDefinitions = cr_dept_cost_tmp.DataDefinition.ParameterFields;
			...
			CrystalReportViewer1.ReportSource = cr_dept_cost_tmp;
			
			Cursor = Cursors.Default;
		}
		
		private void frmDeptCost_Closed(object sender, System.EventArgs e)
		{
			rms_var.frmDeptcst = null;
		}
	}
