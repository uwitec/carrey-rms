...
namespace TouchScreen
{
	namespace MySpace
	{
		public class SuitFoodButtonList : System.Collections.CollectionBase
		{
			...
			public void AddNewButton(string SuitCode, string SuitName, string Price)
			{
				...
				aButton.Tag = SuitCode + "," + SuitName + "," + Price;
				aButton.Text = SuitName + "\r\n" + "[" + Price + "元]";
				aButton.Click += new System.EventHandler(ClickHandler);
				
			}
			
			public SuitFoodButtonList(System.Windows.Forms.Panel host, int btnWidth, int btnHeight, Color btnOrignalBackColor, Color btnSelectedBackColor, int btnCountPerLine)
				{
			...
			public void ClickHandler(object sender, System.EventArgs e)
			{
				...
				string suitcode = tmps[0];
				string suitname = tmps[1];
				string price = tmps[2];
				
				rms_var.frmSuit.SuitCode = suitcode;
			}
		}
	}
