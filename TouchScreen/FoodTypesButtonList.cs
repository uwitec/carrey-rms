...
namespace TouchScreen
{
	namespace MySpace
	{
		public class FoodTypesButtonList : System.Collections.CollectionBase
		{
			...
			public void AddNewButton(string foodtypename)
			{
				...
				aButton.Tag = foodtypename;
				aButton.Text = foodtypename;
				aButton.Click += new System.EventHandler(ClickHandler);
				
			}
			
			public FoodTypesButtonList(System.Windows.Forms.Panel host, int btnWidth, int btnHeight, Color btnOrignalBackColor, Color btnSelectedBackColor, int btnCountPerLine)
				{
			...
			public void ClickHandler(object sender, System.EventArgs e)
			{
				...
				string foodtypename = System.Convert.ToString(((Button) sender).Tag);
				
				rms_var.frmMain.GetFoods(foodtypename, 3);
			}
